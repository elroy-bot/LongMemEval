...
def preprocess_questions(data_file, output_dir):
    ...
    for question in data:
        ...
        for i, (session_id, session_date, session) in enumerate(zip(
...
def main():
    ...
    parser.add_argument('--data_file', type=str, default='data/longmemeval_s.json',
                        help='Path to the JSON data file (default: data/longmemeval_s.json)')
    parser.add_argument('--output_dir', type=str, default='data/question_data',
                        help='Path to the output directory (default: data/question_data)')
